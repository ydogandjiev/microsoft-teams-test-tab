...
const initializeAppModules = () => {
    try {
        ...
        addModule({
            ...
            hasOutput: true,
            action: function (taskInfo, output) {
                MicrosoftTeams_min["tasks"].startTask(taskInfo, (result) => {

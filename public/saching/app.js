...
const initializeAppModules = () => {
    ...
    setTimeout(function (event) {
        MicrosoftTeams_min["notifyAppLoad"]();
    }, 2000);
    setTimeout(function (event) {
        MicrosoftTeams_min["notifyAppInitializationSuccess"]();
    }, 5000);
    addModule({
        name: "getContext",

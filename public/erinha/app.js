...
// EXTERNAL MODULE: ./node_modules/@microsoft/metaos-app-sdk/dist/metaos.min.js
var metaos_min = __webpack_require__(111);
...
const initializeAppModules = () => {
    try {
        var childWindow;
        let totalStates = 0;
        metaos_min.core.initialize();
        metaos_min.appInitialization.notifyAppLoaded();
        addModule({
            name: "getContext",
            initializedRequired: true,
            hasOutput: true,
            action: function (output) {
                metaos_min.core.getContext(output);
            }
        });
        addModule({
            ...
            hasOutput: true,
            action: function (output) {
                metaos_min.teamsCore.getTabInstances(output);
            }
        });
        addModule({
            ...
            hasOutput: true,
            action: function (output) {
                metaos_min.teamsCore.getMruTabInstances(output);
            }
        });
        addModule({
            ...
            action: function (url) {
                (0,metaos_min.navigateCrossDomain)(url);
            }
        });
        addModule({
            name: "returnFocus",
            ...
            action: function (navigateForward) {
                (0,metaos_min.returnFocus)(navigateForward);
            }
        });
        addModule({
            ...
            hasOutput: true,
            action: function (output) {
                metaos_min.core.registerOnThemeChangeHandler(output);
            }
        });
        addModule({
            name: "navigateCrossDomain",
        ...
        addModule({
            ...
            hasOutput: true,
            action: function (output) {
                metaos_min.teamsCore.registerChangeSettingsHandler(function () {
        ...
        addModule({
            ...
            hasOutput: true,
            action: function (output) {
                metaos_min.teamsCore.registerAppButtonClickHandler(function () {
        ...
        addModule({
            ...
            hasOutput: true,
            action: function (output) {
                metaos_min.teamsCore.registerAppButtonHoverEnterHandler(function () {
        ...
        addModule({
            ...
            hasOutput: true,
            action: function (output) {
                metaos_min.teamsCore.registerAppButtonHoverLeaveHandler(function () {
        ...
        addModule({
            ...
            action: function (deepLinkParameters) {
                metaos_min.core.shareDeepLink(deepLinkParameters);
            }
        });
        addModule({
            ...
            action: function (deepLink) {
                metaos_min.core.executeDeepLink(deepLink);
            }
        });
        addModule({
            ...
            action: function (url, output) {
                metaos_min.authentication.authenticate({
                    url: url,
        ...
        addModule({
            ...
            action: function (taskInfo, output) {
                childWindow = metaos_min.tasks.startTask(taskInfo);
        ...
        addModule({
            ...
            action: function (message, output) {
                var parentWindow = metaos_min.ParentAppWindow.Instance;
                if (parentWindow) {
        ...
        addModule({
            ...
            action: function (showNotificationParameters) {
                (0,metaos_min.showNotification)(showNotificationParameters);
            }
        });
        addModule({
            name: "getAuthToken",
            ...
            action: function (getAuthTokenParameters, output) {
                ...
                metaos_min.authentication.getAuthToken(getAuthTokenParameters);
            }
        });
        addModule({
            ...
            action: function (reason) {
                metaos_min.authentication.notifyFailure(reason);
            }
        });
        addModule({
            ...
            action: function (result) {
                metaos_min.authentication.notifySuccess(result);
            }
        });
        addModule({
            ...
            hasOutput: true,
            action: function (output) {
                metaos_min.settings.getSettings(output);
            }
        });
        addModule({
            ...
            hasOutput: true,
            action: function (output) {
                metaos_min.settings.registerOnSaveHandler(function (saveEvent) {
                    window.saveEvent = saveEvent;
                    const configUrl = window.location.href;
                    metaos_min.settings.setSettings({
        ...
        addModule({
            ...
            action: function (validityState) {
                metaos_min.settings.setValidityState(validityState);
            }
        });
        addModule({
            ...
            hasOutput: true,
            action: function (output) {
                metaos_min.settings.registerOnRemoveHandler(function (removeEvent) {
        ...
        addModule({
            ...
            action: function (filePreviewParameters) {
                (0,metaos_min.openFilePreview)(filePreviewParameters);
            }
        });
        addModule({
            ...
            action: function (result, appId) {
                metaos_min.tasks.submitTask(result, appId);
            }
        });
        addModule({
            ...
            hasOutput: true,
            action: function (taskInfo, output) {
                metaos_min.tasks.startTask(taskInfo, (error, result) => {
                    if (error) {
                        output("Error: " + error);
                    }
                    else {
        ...
        addModule({
            ...
            action: function (taskInfo) {
                metaos_min.tasks.updateTask(taskInfo);
            }
        });
        addModule({
            name: "downloadFile ShowNotificationOnly",
        ...
        addModule({
            ...
            hasOutput: true,
            action: function (output) {
                (0,metaos_min.getChatMembers)(output);
            }
        });
        addModule({
            ...
            hasOutput: true,
            action: function (output) {
                (0,metaos_min.getUserJoinedTeams)(output);
            }
        });
        addModule({
            ...
            action: function (readyToUnloadDelay) {
                ...
                metaos_min.teamsCore.registerBeforeUnloadHandler(function (readyToUnload) {
        ...
        addModule({
            ...
            action: function (output) {
                output("total States: " + totalStates);
                metaos_min.teamsCore.registerBackButtonHandler(function () {
                    if (totalStates > 0) {
                        totalStates--;
        ...
        addModule({
            ...
            action: function (openConversationRequest, output) {
                ...
                try {
                    metaos_min.conversations.openConversation(openConversationRequest);
                }
                catch (e) {
                    output("Error" + e);
                }
        ...
        addModule({
            ...
            initializedRequired: true,
            action: function () {
                metaos_min.conversations.closeConversation();
            }
        });
        addModule({
            name: "captureImage",
            ...
            hasOutput: true,
            action: (output) => {
                metaos_min.media.captureImage((err, files) => {
                    if (err) {
                        output(err);
                        return;
                    }
        ...
        addModule({
            ...
            action: (mediaInputs, output) => {
                metaos_min.media.selectMedia(mediaInputs, (err, medias) => {
                    if (err) {
                        output(err);
                        return;
                    }
        ...
        addModule({
            ...
            action: (inputParams, output) => {
                metaos_min.media.selectMedia(inputParams, (err, medias) => {
                    if (err) {
                        output(err);
                        return;
                    }
        ...
        addModule({
            ...
            action: (selectMediaInputs, output) => {
                metaos_min.media.selectMedia(selectMediaInputs, (err, medias) => {
                    if (err) {
                        output(err);
                        return;
                    }
                    ...
                    metaos_min.media.viewImages(urlList, (gmErr) => {
                        if (gmErr) {
                            output(gmErr);
                            return;
                        }
        ...
        addModule({
            ...
            action: (imageUrls, output) => {
                ...
                metaos_min.media.viewImages(urlList, (err) => {
                    if (err) {
                        output(err);
                        return;
                    }
        ...
        addModule({
            ...
            action: (locationProps, output) => {
                metaos_min.location.getLocation(locationProps, (err, location) => {
                    if (err) {
                        output(err);
                        return;
                    }
        ...
        addModule({
            ...
            action: (location, output) => {
                metaos_min.location.showLocation(location, (err, result) => {
                    if (err) {
                        output(err);
                        return;
                    }
        ...
        addModule({
            ...
            action: (scanBarCodeConfig, output) => {
                metaos_min.media.scanBarCode((err, result) => {
                    if (err) {
                        output(err);
                        return;
                    }
        ...
        metaos_min.appInitialization.notifySuccess();
    }
    catch (err) {
        metaos_min.appInitialization.notifyFailure({ reason: metaos_min.appInitialization.FailedReason.Other, message: err.message });
    }
};

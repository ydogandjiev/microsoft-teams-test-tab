...
const renderPage = () => {
    ...
    try {
        MicrosoftTeams_min.app.initialize()
            .then(() => {
            registerAppCachingHandlers();
            // This tests a specific scenario where the tab is reloaded on unload
            handleReloadOnUnload(MicrosoftTeams_min.sendCustomMessage);
        });
        MicrosoftTeams_min.app.notifyAppLoaded();
        initializeAppModules();
        MicrosoftTeams_min.app.notifySuccess();
    }
    catch (err) {
        console.error(`Failed during app initialization. Error: ${err.message || err}`);
        MicrosoftTeams_min.app.notifyFailure({
            reason: MicrosoftTeams_min.app.FailedReason.Other,
            message: err.message,
        });
    }
};
const registerAppCachingHandlers = () => {
    MicrosoftTeams_min.teamsCore.registerBeforeUnloadHandler((readyToUnload) => {
        const result = beforeUnloadHandler(readyToUnload);
        return result;
    });
    MicrosoftTeams_min.teamsCore.registerOnLoadHandler((data) => {
        loadHandler(data);
    });
};
...
const initializeAppModules = () => {
    ...
    addModule({
        ...
        hasOutput: false,
        action: function () {
            MicrosoftTeams_min.teamsCore.print();
        },
    });
    addModule({
        name: "app.getContext",
    ...
    addModule({
        ...
        hasOutput: true,
        action: function (output) {
            MicrosoftTeams_min.pages.tabs.getTabInstances()
                .then(output);
        },
    });
    addModule({
        ...
        hasOutput: true,
        action: function (output) {
            MicrosoftTeams_min.pages.tabs.getMruTabInstances()
                .then(output);
        },
    });
    addModule({
        ...
        action: function (url) {
            MicrosoftTeams_min.pages.navigateCrossDomain(url);
        },
    });
    addModule({
    ...
    addModule({
        ...
        hasOutput: true,
        action: function (output) {
            MicrosoftTeams_min.app.registerOnThemeChangeHandler(output);
        },
    });
    addModule({
        ...
        hasOutput: true,
        action: function (output) {
            MicrosoftTeams_min.pages.config.registerChangeConfigHandler(function () {
    ...
    addModule({
        ...
        hasOutput: true,
        action: function (output) {
            MicrosoftTeams_min.pages.appButton.onClick(function () {
    ...
    addModule({
        ...
        hasOutput: true,
        action: function (output) {
            MicrosoftTeams_min.pages.appButton.onHoverEnter(function () {
    ...
    addModule({
        ...
        hasOutput: true,
        action: function (output) {
            MicrosoftTeams_min.pages.appButton.onHoverLeave(function () {
    ...
    addModule({
        ...
        action: function (deepLinkParameters) {
            MicrosoftTeams_min.pages.shareDeepLink(deepLinkParameters);
        },
    });
    addModule({
        ...
        action: function (deepLink) {
            MicrosoftTeams_min.app.openLink(deepLink);
        },
    });
    addModule({
        name: "navigateToApp",
    ...
    addModule({
        ...
        hasOutput: true,
        action: function (output) {
            MicrosoftTeams_min.pages.getConfig().then(output);
        },
    });
    addModule({
        ...
        hasOutput: true,
        action: function (output) {
            MicrosoftTeams_min.pages.config.registerOnSaveHandler(function (saveEvent) {
                window.saveEvent = saveEvent;
                const configUrl = window.location.href;
                MicrosoftTeams_min.pages.config.setConfig({
    ...
    addModule({
        ...
        action: function (settings, output) {
            MicrosoftTeams_min.pages.config.setConfig(settings);
        },
    });
    addModule({
        ...
        action: function (validityState) {
            MicrosoftTeams_min.pages.config.setValidityState(validityState);
        },
    });
    addModule({
        ...
        hasOutput: true,
        action: function (output) {
            MicrosoftTeams_min.pages.config.registerOnRemoveHandler(function (removeEvent) {
    ...
    addModule({
        ...
        action: function (output) {
            output("total States: " + totalStates);
            MicrosoftTeams_min.pages.backStack.registerBackButtonHandler(function () {
                if (totalStates > 0) {
                    totalStates--;
    ...
    addModule({
        ...
        action: (tab, hostEntityIds, output) => {
            MicrosoftTeams_min.hostEntity.tab.remove(tab, hostEntityIds)
                .then((result) => {
    ...
    addModule({
        ...
        action: (frameContext) => {
            MicrosoftTeams_min.pages.setCurrentFrame(frameContext);
        },
    });
    addModule({
        name: "navigateToTab",
    ...
    addModule({
        ...
        hasOutput: true,
        action: function (output) {
            MicrosoftTeams_min.clipboard.read()
                .then((result) => {
                output(result);
            })
                .catch((error) => {
    ...
    addModule({
        ...
        action: function (content, output) {
            MicrosoftTeams_min.clipboard.write(content)
                .then((result) => {
                output(result);
            })
                .catch((error) => {
...
/******/ })()
;
//# sourceMappingURL=app.de18566822abc533ecef.js.map